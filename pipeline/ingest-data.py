...
# #### Sort out dtypes since csv doesn't keep schema
...
# ##### Upload data by chunks - create ann iterator to loop through
...
def run(pg_user, pg_pass, pg_host, pg_port, pg_db, year, month, chunksize, table_name):
